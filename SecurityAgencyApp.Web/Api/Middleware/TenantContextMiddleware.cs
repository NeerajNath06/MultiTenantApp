...
public class TenantContextMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
            ...
            !tc.TenantId.HasValue)
        {
            ...
            var body = JsonSerializer.Serialize(ApiResponse<object?>.ErrorResponse(
                "Tenant context is required. Provide X-Tenant-Id header or ensure your token includes TenantId.",
                new[] { ApiError.Create("Missing or invalid tenant context.") }));
