...
[ApiController]
public abstract class GenericCrudControllerBase<TListResponse, TDetailsResponse, TListQuery, TGetByIdQuery, TCreateCommand, TUpdateCommand, TDeleteCommand> : ControllerBase
    ...
    where TDeleteCommand : class, IRequest<ApiResponse<bool>>
{
    ...
    protected GenericCrudControllerBase(IMediator mediator)
    {
        _mediator = mediator;
    }
