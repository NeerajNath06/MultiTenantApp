...
[ApiController]
public abstract class GenericDetailedReadCreateDeleteControllerBase<TListResponse, TDetailsResponse, TListQuery, TGetByIdQuery, TCreateCommand, TCreateResponse, TDeleteCommand> : ControllerBase
    ...
    where TDeleteCommand : class, IRequest<ApiResponse<bool>>
{
    ...
    protected GenericDetailedReadCreateDeleteControllerBase(IMediator mediator)
    {
        _mediator = mediator;
    }
