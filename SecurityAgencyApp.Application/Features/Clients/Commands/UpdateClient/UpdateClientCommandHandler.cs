...
public class UpdateClientCommandHandler : IRequestHandler<UpdateClientCommand, ApiResponse<bool>>
{
    ...
    public async Task<ApiResponse<bool>> Handle(UpdateClientCommand request, CancellationToken cancellationToken)
    {
        ...
        client.BillingCity = request.BillingCity;
        client.BillingState = request.BillingState;
        client.BillingPinCode = request.BillingPinCode;
        client.GSTNumber = request.GSTNumber;
        client.PANNumber = request.PANNumber;
        client.Website = request.Website;
        client.AccountManagerName = request.AccountManagerName;
        client.BillingContactName = request.BillingContactName;
        client.BillingContactEmail = request.BillingContactEmail;
        client.EscalationContactName = request.EscalationContactName;
        client.EscalationContactEmail = request.EscalationContactEmail;
        client.CreditPeriodDays = request.CreditPeriodDays;
        client.BillingCycle = request.BillingCycle;
        client.GstState = request.GstState;
        client.PaymentModePreference = request.PaymentModePreference;
        client.TaxTreatment = request.TaxTreatment;
        client.InvoicePrefix = request.InvoicePrefix;
        client.SlaTerms = request.SlaTerms;
        client.EscalationTatHours = request.EscalationTatHours;
        client.PenaltyTerms = request.PenaltyTerms;
